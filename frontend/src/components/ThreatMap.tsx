        ...
        const fetchData = async () => {
            try {
                const [tResp, vResp] = await Promise.all([
                    ...
                    fetch(`${config.gatewayUrl}/api/vulnerability-scan`),
                ]);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <GlassExpand title="THREAT LANDSCAPE">
                ...
                {/* Vulnerability Scan */}
                <GlassExpand title="VULNERABILITY ASSESSMENT">
            ...
            {/* Findings Table */}
            <GlassExpand title="SECURITY FINDINGS">
                <div className="glass-panel p-5 rounded">
                    <h3 className="text-sm font-bold text-white mb-4 flex items-center gap-2">
